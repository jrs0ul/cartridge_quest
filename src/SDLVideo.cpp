                          ...
                          bool useVulkan)
{
    ...
    else //  Vulkan
    {
        ...
        {
            vkSwapchainImageViews[i] = VulkanVideo::createImageView(vkDevice, vkSwapchainImages[i], vkSurfaceFormat.format, VK_IMAGE_ASPECT_COLOR_BIT);
        }
        ...
        VkImageView depthImageView = VulkanVideo::createImageView(vkDevice, depthImage, VK_FORMAT_D32_SFLOAT_S8_UINT, VK_IMAGE_ASPECT_DEPTH_BIT);
